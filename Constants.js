...
export const CONFIG = {
    ...
    HOTEL_RENT: 500,
    CONDO_SALE: 150000,
    CONDO_RENT: 200, // Added daily occupancy rent
    PARKING_INCOME: 50,
    FOOD_INCOME: 200,
    CINEMA_INCOME: 300,
    RETAIL_INCOME: 150,
...
export const TYPES = {
    EMPTY: 0, LOBBY: 1, OFFICE: 2, CONDO: 3, HOTEL: 4, FOOD: 5, 
    PARKING: 6, STAIRS: 7, ELEVATOR: 8, CLEANING_SERVICE: 9, 
    ELEVATOR_EXPRESS: 10, CINEMA: 11, CATHEDRAL: 12, SECURITY: 13, 
    METRO: 14, SKY_LOBBY: 15, MEDICAL: 16, RECYCLING: 17, 
    RETAIL: 18, ELEVATOR_SERVICE: 19, TAKEN: 99
};
...
export const ROOM_PROPS = {
    ...
    [TYPES.CATHEDRAL]:        { w: 4, cost: 100000, label: 'Cathedral' },
    [TYPES.SECURITY]:         { w: 2, cost: 30000,  label: 'Security' },
    [TYPES.METRO]:            { w: 3, cost: 50000,  label: 'Metro' },
    [TYPES.MEDICAL]:          { w: 3, cost: 40000,  label: 'Medical' },
    [TYPES.RECYCLING]:        { w: 2, cost: 20000,  label: 'Recycling' },
    [TYPES.ELEVATOR_SERVICE]: { w: 2, cost: 2000,   label: 'Service Lift' }
};
